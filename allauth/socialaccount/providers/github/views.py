...
class GitHubOAuth2Adapter(OAuth2Adapter):
    ...
    access_token_url = "{}/login/oauth/access_token".format(web_url)
    authorize_url = "{}/login/oauth/authorize".format(web_url)
    profile_url = "{}/user".format(api_url)
    emails_url = "{}/user/emails".format(api_url)
