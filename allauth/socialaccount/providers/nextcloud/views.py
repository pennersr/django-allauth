...
class NextCloudAdapter(OAuth2Adapter):
    ...
    access_token_url = "{}/apps/oauth2/api/v1/token".format(server)
    authorize_url = "{}/apps/oauth2/authorize".format(server)
    profile_url = "{}/ocs/v1.php/cloud/users/".format(server)
    ...
    def get_user_info(self, token, user_id):
        headers = {"Authorization": "Bearer {}".format(self.server)}
