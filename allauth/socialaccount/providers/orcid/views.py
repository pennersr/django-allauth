...
class OrcidOAuth2Adapter(OAuth2Adapter):
    ...
    authorize_url = "https://{}/oauth/authorize".format(base_domain)
    access_token_url = "https://{}/oauth/token".format(api_domain)
    profile_url = "https://{}/v2.1/%s/record".format(api_domain)
