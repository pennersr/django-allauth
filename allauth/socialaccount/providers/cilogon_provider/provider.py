...
from allauth.socialaccount.providers.base_provider import AuthAction, ProviderAccount
from allauth.socialaccount.providers.cilogon_provider.views import CILogonOAuth2Adapter
