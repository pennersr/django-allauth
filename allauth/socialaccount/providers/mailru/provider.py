...
class MRUAccount(ProviderAccount):
    ...
    def to_str(self):
        dflt = super(MRUAccount, self).to_str()
        return self.account.extra_data.get('name', dflt)


class MRUProvider(OAuth2Provider):
    id = 'mailru'
    name = 'Mail.RU'
    package = 'allauth.socialaccount.providers.mailru'
    account_class = MRUAccount
...
providers.registry.register(MRUProvider)
