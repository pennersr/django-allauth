...
class GitLabOAuth2Adapter(OAuth2Adapter):
    ...
    access_token_url = "{}/oauth/token".format(provider_base_url)
    authorize_url = "{}/oauth/authorize".format(provider_base_url)
    profile_url = "{}/api/{}/user".format(provider_base_url, provider_api_version)
