...
class MicrosoftGraphOAuth2Adapter(OAuth2Adapter):
    ...
    def __init__(self, request):
        ...
        base_url = "https://login.microsoftonline.com/{}".format(tenant)
        self.access_token_url = "{}/oauth2/v2.0/token".format(base_url)
        self.authorize_url = "{}/oauth2/v2.0/authorize".format(base_url)
