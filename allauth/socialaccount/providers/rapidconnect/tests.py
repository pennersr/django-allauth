...
from . import views
from .provider import RapidconnectProvider
...
#         self.provider = providers.registry.by_id(rapidconnectProvider.id)
...
#         with patch(
#             "allauth.socialaccount.providers.rapidconnect.views" ".rapidconnect_complete_login"
#         ) as rapidconnect_complete_login:
#             self.mock_socialaccount_state()

#             response_json = self.get_rapidconnect_login_response()

#             token = SocialToken(app=self.app, token=response_json["apikey"])
#             login = self.get_socialaccount(response_json, token)

#             rapidconnect_complete_login.return_value = login
