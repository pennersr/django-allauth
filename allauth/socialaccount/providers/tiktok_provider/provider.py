...
from allauth.socialaccount.providers.tiktok_provider.scope import TikTokScope
from allauth.socialaccount.providers.tiktok_provider.views import TikTokOAuth2Adapter
